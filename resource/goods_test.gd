#class_name Goods_Test extends ItemData
#
#enum Class {
	#None = -1,
...
#@export var slot: Vector2i = Vector2i(0, 0)
...
#
#
#func init(tmp_name: String, tmp_quality: Quality, tmp_slot: Vector2i, tmp_value: int, tmp_class: Class = Class.CraftCollection) -> void:
	#name = tmp_name
	#quality = tmp_quality
	#slot = tmp_slot
	#value = tmp_value
